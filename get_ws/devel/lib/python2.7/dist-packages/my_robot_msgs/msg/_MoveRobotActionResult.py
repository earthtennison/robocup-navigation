...
"""autogenerated by genpy from my_robot_msgs/MoveRobotActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveRobotActionResult(genpy.Message):
  ...
  _type = "my_robot_msgs/MoveRobotActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_robot_msgs/MoveRobotResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = my_robot_msgs.msg.MoveRobotResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_robot_msgs.msg.MoveRobotResult()
