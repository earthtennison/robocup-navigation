...
(cl:defmethod cl:initialize-instance :after ((m <MoveRobotGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveRobotGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot_msgs-msg:<MoveRobotGoal> is deprecated: use my_robot_msgs-msg:MoveRobotGoal instead.")))
