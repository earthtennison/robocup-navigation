...
bool operator==(const ::turtlebot3_applications_msgs::TakePanoramaResponse_<ContainerAllocator1> & lhs, const ::turtlebot3_applications_msgs::TakePanoramaResponse_<ContainerAllocator2> & rhs)
{
