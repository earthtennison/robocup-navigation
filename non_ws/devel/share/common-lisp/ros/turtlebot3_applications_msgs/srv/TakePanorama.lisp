...
(cl:in-package turtlebot3_applications_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <TakePanorama-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TakePanorama-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot3_applications_msgs-srv:<TakePanorama-request> is deprecated: use turtlebot3_applications_msgs-srv:TakePanorama-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <TakePanorama-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_applications_msgs-srv:mode-val is deprecated.  Use turtlebot3_applications_msgs-srv:mode instead.")
  (mode m))

(cl:ensure-generic-function 'pano_angle-val :lambda-list '(m))
(cl:defmethod pano_angle-val ((m <TakePanorama-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_applications_msgs-srv:pano_angle-val is deprecated.  Use turtlebot3_applications_msgs-srv:pano_angle instead.")
  (pano_angle m))

(cl:ensure-generic-function 'snap_interval-val :lambda-list '(m))
(cl:defmethod snap_interval-val ((m <TakePanorama-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_applications_msgs-srv:snap_interval-val is deprecated.  Use turtlebot3_applications_msgs-srv:snap_interval instead.")
  (snap_interval m))

(cl:ensure-generic-function 'rot_vel-val :lambda-list '(m))
(cl:defmethod rot_vel-val ((m <TakePanorama-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_applications_msgs-srv:rot_vel-val is deprecated.  Use turtlebot3_applications_msgs-srv:rot_vel instead.")
  (rot_vel m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TakePanorama-request>)))
  ...
  "turtlebot3_applications_msgs/TakePanoramaRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TakePanorama-request)))
  "Returns string type for a service object of type 'TakePanorama-request"
  "turtlebot3_applications_msgs/TakePanoramaRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TakePanorama-request>)))
  ...
  "51aa7cafe47f8d721c031cb234513c3b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TakePanorama-request)))
  "Returns md5sum for a message object of type 'TakePanorama-request"
  "51aa7cafe47f8d721c031cb234513c3b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TakePanorama-request>)))
  ...
  (cl:format cl:nil "########################################~%# CONSTANTS~%########################################~%uint8 SNAPANDROTATE=0 # mode: rotate, stop, snapshot, rotate, stop, snapshot, ...~%uint8 CONTINUOUS=1    # mode: keep rotating while taking snapshots~%uint8 STOP=2          # mode: stop an ongoing panorama creation~%~%uint8 STARTED=0       # status~%uint8 IN_PROGRESS=1   # status~%uint8 STOPPED=2       # status~%~%########################################~%# Messages~%########################################~%uint8 mode            # mode for taking the pictures~%float32 pano_angle    # total angle of panorama picture~%float32 snap_interval # angle interval when creating the panorama picture in snap&rotate mode, time interval otherwise ~%float32 rot_vel       # rotating velocity~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TakePanorama-request)))
  "Returns full string definition for message of type 'TakePanorama-request"
  (cl:format cl:nil "########################################~%# CONSTANTS~%########################################~%uint8 SNAPANDROTATE=0 # mode: rotate, stop, snapshot, rotate, stop, snapshot, ...~%uint8 CONTINUOUS=1    # mode: keep rotating while taking snapshots~%uint8 STOP=2          # mode: stop an ongoing panorama creation~%~%uint8 STARTED=0       # status~%uint8 IN_PROGRESS=1   # status~%uint8 STOPPED=2       # status~%~%########################################~%# Messages~%########################################~%uint8 mode            # mode for taking the pictures~%float32 pano_angle    # total angle of panorama picture~%float32 snap_interval # angle interval when creating the panorama picture in snap&rotate mode, time interval otherwise ~%float32 rot_vel       # rotating velocity~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <TakePanorama-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TakePanorama-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot3_applications_msgs-srv:<TakePanorama-response> is deprecated: use turtlebot3_applications_msgs-srv:TakePanorama-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <TakePanorama-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_applications_msgs-srv:status-val is deprecated.  Use turtlebot3_applications_msgs-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TakePanorama-response>)))
  ...
  "turtlebot3_applications_msgs/TakePanoramaResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TakePanorama-response)))
  "Returns string type for a service object of type 'TakePanorama-response"
  "turtlebot3_applications_msgs/TakePanoramaResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TakePanorama)))
  ...
  "turtlebot3_applications_msgs/TakePanorama")